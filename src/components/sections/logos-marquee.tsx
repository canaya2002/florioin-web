    ...
    <Container size="wide" as="section" bleed className="bg-white">
      ...
      <Marquee pauseOnHover>
        {PLACEHOLDER_LOGOS.map((name) => (
          ...
          >
            <span className="font-display text-[clamp(20px,1.6vw,28px)] tracking-tight text-[var(--fg-subtle)] opacity-70 transition-opacity duration-[var(--duration-fast)] hover:opacity-100">
              {name}
            </span>
          </div>
        ))}
